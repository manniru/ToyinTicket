(function($, console, doc) {
	...
	AddCardViewModel = kendo.data.ObservableObject.extend({
		...
		Register: function() {
			...
			var getParams={type: "register", username: username, password: password, fullname: fullname, mobileno: mobileno, amount: amount};
 
$.getJSON("http://localhost/server/json.php",getParams,
    function(data, textStatus, jqXHR)
    {
		...
		alert("hi");
			...
			window.location.replace("#views/Login.html");
				///$.post('http://localhost/server/json.php',{ username: "user1", password: "123", fullname: "User One", mobileno: "601123063352", amount: "150" }, function(data){
...
$.getJSON("http://localhost/server/json.php",getParams,
	...
	RewardsViewModel = CardsViewModelBase.extend({
		...
		setValues: function(cardNumber, bonusPoints) {
			...
			that.set("cardNumber", "No:" + cardNumber);
			that.set("bonusPoints", "Movie Price:" + bonusPoints);
